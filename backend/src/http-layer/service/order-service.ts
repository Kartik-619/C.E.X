...
export class OrderService {
    ...
    async addOrder(dto: CreateOrderRequestDTO): Promise<OrderResponseDTO> {
        ...
        // ✅ FIX: Changed from processOrder to createOrder to ensure NO matching occurs
        // (Assuming StandardEngine.createOrder exists as the passive placement method)
        const placedOrder = await this.engine.createOrder(domainOrder);
